// GhostTrace - Public Suffix List verisi (otomatik uretildi, elle duzenlemeyin)
// Kaynak : https://publicsuffix.org/list/public_suffix_list.dat
// Lisans : Mozilla Public License 2.0
// Surum  : 2026-08-19_19-18-48_UTC
// Not    : Tek etiketli kurallar (com, net, tr ...) atlanmistir; algoritma bunlari
//          varsayilan olarak zaten tek etiketli public suffix kabul eder.

export const PSL_VERSION = '2026-08-19_19-18-48_UTC';
export const PSL_MAX_LABELS = 7;

// Cok etiketli birebir kurallar (ornek: co.uk, com.tr, github.io)
const LITERAL_RULES = `0.bg
0am.jp
0g0.jp
0j0.jp
0t0.jp
...
const WILDCARD_RULES = `001.test.code-builder-stg.platform.salesforce.com
0e.vc
0emm.com
aa.crm.dev
ab.crm.dev
...
const EXCEPTION_RULES = `city.kawasaki.jp
city.kitakyushu.jp
city.kobe.jp
city.nagoya.jp
city.sapporo.jp
